...
public class PurchasingInformations {
    ...
    static protected Map<String, Double> purchaseListFood = new TreeMap<>();
    static protected Map<String, Double> purchaseListClothes = new TreeMap<>();
    static protected Map<String, Double> purchaseListEntertainments = new TreeMap<>();
    static protected Map<String, Double> purchaseListOther = new TreeMap<>();
    static protected Map<String, Double> purchaseListAll = new TreeMap<>();

    static Map<String, Double> purchasePerCategory(String userSelection, Map<String, Double> finalPurchaseList){
